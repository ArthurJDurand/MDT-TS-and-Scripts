...
Rename your Serer to "SERVER" (without quotes)  
...
Look at the scope/range of your DHCP router and set the scope/range to e.g. 192.168.1.101-199 or whatever suits your network environment (reserve some IP adresses for static IP addresses and for the deployment server to respond to PXE requests!  
Configure your server to use a static IP address on your current subnet (choose a static IP address within yout current subnet and outside of the scope/range of your DHCP enabled router/server, e.g. 192.168.1.200!  
