...
if %Unattend% EQU 0 (
if %_Debug% EQU 0 (title %_title%) else (set "_title=KMS %uivr% : %mode%"&title KMS %uivr% : %mode%)
) else (
echo.
echo Running KMS %uivr%
)
...
:CreateBIN
cls
if exist "!_oem!\KMS-bin\*.dll" if exist "!_oem!\KMS-bin\*.cab" (
echo.&echo %line3%&echo.
...
if not exist "!_oem!\KMS-bin\*.dll" mkdir "!_oem!\KMS-bin"
pushd "!_oem!\KMS-bin"
%_Nul3% rmdir /s /q .
setlocal
set "TMP=%SystemRoot%\Temp"
  ...
  <body>
    <main>
        <div class="innertube">
            ...
            <h1 id="Overview">KMS - Smart Activation Script</h1>
    <ul>
    ...
    <ul>
      ...
      Backup links:<br />
      <a href="https://github.com/abbodi1406/KMS" target="_blank">https://github.com/abbodi1406/KMS</a><br />
    ...
    <p>The KMS fork has these differences and extra features compared to the traditional KMS_VL_ALL:</p>
    <ul>
    ...
    <ul>
      <li>KMS offer 3 flavors of activation modes.</li>
    </ul>
            <hr />
            <br />
...
Windows.cmd /s
    ...
    <ul>
      <li>KMS script is coded to correctly handle those limitations, as much as possible.</li>
    </ul>
    <ul>
